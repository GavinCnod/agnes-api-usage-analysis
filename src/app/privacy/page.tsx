...
export function generateMetadata(): Metadata {
  const title = "Privacy Policy — Agnes AI Usage Analytics Dashboard";
  const description =
    "Privacy Policy for the Agnes AI Usage Analytics Dashboard. Learn how we handle your data: all CSV processing is local, no data is uploaded, and Google Analytics is opt-in. Built by Gavin & MindRose Team.";
