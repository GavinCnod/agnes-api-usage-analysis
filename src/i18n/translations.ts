...
const translations = {
  ...
  zh: {
    ...
    kpi: {
      ...
      totalTextTokens: "文本 Token 总量",
      totalRequests: "总请求数",
      activeKeys: "活跃 Key 数",
      generatedImages: "生成图片数量",
      generatedVideoSeconds: "生成视频总长度（秒）",
      requestsPerKey: "{count} 个活跃 Key",
      models: "{count} 个模型",
    },
    metrics: {
      textTokens: "文本 Token",
      tabTextTokens: "文本 Token 总量",
      images: "图片数量",
      tabImages: "生成图片数量",
      videoSeconds: "视频时长（秒）",
      tabVideoSeconds: "生成视频总长度（秒）",
      requests: "请求数",
      cost: "费用",
    },
    overview: {
      ...
      dailyCoreMetrics: "每日核心指标（相对对比）",
      coreMetricsByKey: "各 Key 核心指标对比（相对对比）",
      normalizedHint: "当前为相对对比视图，悬浮可查看真实数值",
    },
    trends: {
      dailyCost: "每日费用",
      dailyTokens: "每日 Token",
