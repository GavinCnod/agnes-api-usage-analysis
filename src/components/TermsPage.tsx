...
export function TermsPage() {
  ...
  const termsJsonLd = useMemo(() => {
    ...
    return {
      ...
      "@type": "WebPage",
      name: isZh
        ? "使用条款 — Agnes AI Usage Analysis"
        : "Terms of Use — Agnes AI Usage Analysis",
      description: isZh
        ? "Agnes AI Usage Analysis 使用条款。按现状提供的开源软件，无担保，与 Agnes AI 官方无隶属关系。由 Gavin Chen 和 MindRose 团队开发维护。"
        : "Terms of Use for Agnes AI Usage Analysis. As-is open source software under the MIT License, no warranty, and not affiliated with the official Agnes AI service. Built by Gavin Chen & MindRose Team.",
      about: {
        "@type": "Thing",
