...
function createShareCardStrings(): ShareCardStrings {
  return {
    tabLabel: "Overview",
    appName: "Agnes AI Usage Analytics",
    fromLabel: "From",
    textTokensLabel: "Total Text Tokens",
    imagesLabel: "Generated Images",
    videoSecondsLabel: "Video Length (s)",
    ...
    relativeComparisonLabel: "Relative Comparison",
    dailyCoreMetricsLabel: "Daily Core Metrics (Relative Comparison)",
    coreMetricsTrendLabel: "Core Metrics Trend (Relative Comparison)",
    peakLabel: "Peak",
    lowestLabel: "Lowest",
...
describe("ShareCard", () => {
  it("在总览模式下固定渲染三维 Hero，并默认展示文本 Token 图表口径", () => {
    ...
    expect(screen.getAllByText("Relative Comparison").length).toBeGreaterThan(0);
    expect(screen.getAllByText("Daily Core Metrics (Relative Comparison)").length).toBeGreaterThan(0);
    ...
    expect(option.series[0].data).toEqual([50, 100]);
  });
  ...
  it("在 Key 模式下保持三维 Hero 固定，并在无 Token 时切换为图片指标排行", () => {
    ...
    expect(screen.getAllByText("Generated Images").length).toBeGreaterThan(0);
    expect(screen.getAllByText("Video Length (s)").length).toBeGreaterThan(0);
    expect(screen.getAllByText("Chart Metric: Generated Images").length).toBeGreaterThan(0);
...
describe("ShareModal", () => {
  ...
  it("在趋势预览摘要中保留三维 Hero，并在无 Token 时回退为图片指标", async () => {
    ...
    await waitFor(() => {
      expect(screen.getAllByText("Core Metrics Trend (Relative Comparison)").length).toBeGreaterThan(0);
    });
